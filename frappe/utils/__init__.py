...
def get_formatted_email(user):
	"""get Email Address of user formatted as: `John Doe <johndoe@gmail.com>`"""
...
def validate_email_address(email_str, throw=False):
	...
	def _check(e):
		...
		if 'undisclosed-recipient' in e:
			...
			# example: "test@gmail.com test2@gmail.com" will return "test@gmail.comtest2" after parseaddr!!!
			_valid = False
...
def check_format(email_id):
	"""
	Check if email_id is valid. valid email:text@gmail.com
