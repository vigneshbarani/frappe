...
def get_default_outgoing_email_account(raise_exception_not_set=True):
	'''conf should be like:
		{
		 ...
		 "mail_port": 587,
		 "use_tls": 1,
		 "mail_login": "emails@gmail.com",
		 "mail_password": "Super.Secret.Password",
		 "auto_email_id": "emails@gmail.com",
	...
	if not email_account and frappe.conf.get("mail_server"):
		...
		email_account.update({
			...
			"email_id": frappe.conf.get("auto_email_id") or frappe.conf.get("mail_login") or 'notifications@gmail.com',
	...
	if frappe.are_emails_muted():
		...
		email_account = frappe.new_doc("Email Account")
		email_account.update({
			"email_id": "notifications@gmail.com"
		})
