...
class TestPermissions(unittest.TestCase):
	def setUp(self):
		...
		if not frappe.flags.permission_user_setup_done:
			user = frappe.get_doc("User", "test1@gmail.com")
			user.add_roles("Website Manager")
			user.add_roles("System Manager")

			user = frappe.get_doc("User", "test2@gmail.com")
			user.add_roles("Blogger")

			user = frappe.get_doc("User", "test3@gmail.com")
		...
		frappe.set_user("test1@gmail.com")
	...
	def test_user_permissions_in_doc(self):
		...
		frappe.set_user("test2@gmail.com")
	...
	def test_user_permissions_in_report(self):
		add_user_permission("Blog Category", "_Test Blog Category 1", "test2@gmail.com")
	...
	def test_default_values(self):
		...
		add_user_permission("Blog Category", "_Test Blog Category", "test2@gmail.com", ignore_permissions=True)
		frappe.clear_cache()
		doc = frappe.new_doc("Blog Post")
		self.assertFalse(doc.get("blog_category"))

		# Fetch user permission set as default from multiple user permission
		add_user_permission("Blog Category", "_Test Blog Category 2", "test2@gmail.com", ignore_permissions=True, is_default=1)
		frappe.clear_cache()
		doc = frappe.new_doc("Blog Post")
	...
	def test_set_user_permissions(self):
		frappe.set_user("test1@gmail.com")
		add_user_permission("Blog Post", "-test-blog-post", "test2@gmail.com")
	...
	def test_not_allowed_to_set_user_permissions(self):
		...
		self.assertRaises(frappe.PermissionError, add_user_permission,
			"Blog Post", "-test-blog-post", "test2@gmail.com")
	...
	def test_strict_user_permissions(self):
		...
		add_user_permission("Salutation", "Mr", "test3@gmail.com")
		...
		frappe.set_user("test3@gmail.com")
	...
	def test_user_permissions_not_applied_if_user_can_edit_user_permissions(self):
		add_user_permission('Blogger', '_Test Blogger 1', 'test1@gmail.com')

		# test1@gmail.com has rights to create user permissions
	...
	def test_user_permission_is_not_applied_if_user_roles_does_not_have_permission(self):
		add_user_permission('Blog Post', '-test-blog-post-1', 'test3@gmail.com')
		frappe.set_user("test3@gmail.com")
		doc = frappe.get_doc("Blog Post", "-test-blog-post-1")
		self.assertFalse(doc.has_permission("read"))
	...
	def test_contextual_user_permission(self):
		...
		add_user_permission('Blogger', '_Test Blogger', 'test2@gmail.com')
		# should be applicable only while accessing Blog Post
		add_user_permission('Blogger', '_Test Blogger 1', 'test2@gmail.com', applicable_for='Blog Post')
		# should be applicable only while accessing User
		add_user_permission('Blogger', '_Test Blogger 2', 'test2@gmail.com', applicable_for='User')
	...
	def test_clear_user_permissions(self):
		...
		frappe.set_user('Administrator')
		clear_user_permissions_for_doctype('Blog Category', 'test2@gmail.com')
		clear_user_permissions_for_doctype('Blog Post', 'test2@gmail.com')

		add_user_permission('Blog Post', '-test-blog-post-1', 'test2@gmail.com')
		add_user_permission('Blog Post', '-test-blog-post-2', 'test2@gmail.com')
		add_user_permission("Blog Category", '_Test Blog Category 1', 'test2@gmail.com')

		deleted_user_permission_count = clear_user_permissions('test2@gmail.com', 'Blog Post')
