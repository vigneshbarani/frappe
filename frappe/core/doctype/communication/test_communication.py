...
class TestCommunication(unittest.TestCase):
	...
	def test_email(self):
		valid_email_list = ["Full Name <full@gmail.com>",
		'"Full Name with quotes and <weird@chars.com>" <weird@gmail.com>',
	...
	def test_contacts_attached(self):
		...
		contact_sender.add_email("comm_sender@gmail.com")
		...
		contact_recipient.add_email("comm_recipient@gmail.com")
		...
		contact_cc.add_email("comm_cc@gmail.com")
		...
		comm = frappe.get_doc({
			...
			"sender": "comm_sender@gmail.com",
			"recipients": "comm_recipient@gmail.com",
			"cc": "comm_cc@gmail.com"
		}).insert(ignore_permissions=True)
	...
	def test_link_in_email(self):
		...
		comm = frappe.get_doc({
			...
			"sender": "comm_sender@gmail.com",
			"recipients": "comm_recipient+{0}+{1}@gmail.com".format(quote("Note"), quote(note.name)),
		}).insert(ignore_permissions=True)
...
def create_email_account():
	...
	email_account = frappe.get_doc({
		...
		"send_notification_to": "test_comm@gmail.com",
		"pop3_server": "pop.test.gmail.com",
		"no_remaining":"0",
