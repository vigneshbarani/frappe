...
class TestNotification(unittest.TestCase):
	...
	def test_cc_jinja(self):
		...
		frappe.db.sql("""delete from `tabUser` where email='test_jinja@gmail.com'""")
		frappe.db.sql("""delete from `tabEmail Queue`""")
		...
		test_user.email = 'test_jinja@gmail.com'
		...
		self.assertTrue(frappe.db.get_value("Email Queue Recipient", {"recipient": "test_jinja@gmail.com"}))
