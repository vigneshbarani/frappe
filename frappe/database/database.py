...
class Database(object):
	...
	def get_value(self, doctype, filters=None, fieldname="name", ignore=None, as_dict=False,
		...
		Example:
			...
			# return last login of **User** `test@gmail.com`
			frappe.db.get_value("User", "test@gmail.com", "last_login")

			last_login, last_ip = frappe.db.get_value("User", "test@gmail.com",
				["last_login", "last_ip"])
	...
	def get_values(self, doctype, filters=None, fieldname="name", ignore=None, as_dict=False,
		...
		Example:
			...
			# return last login of **User** `test@gmail.com`
			user = frappe.db.get_values("User", "test@gmail.com", "*")[0]
		"""
		out = None
