...
def redirect_to_message(title, html, http_status_code=None, context=None, indicator_color=None):
	...
	Example Usage:
		frappe.redirect_to_message(_('Thank you'), "<div><p>You will receive an email at test@gmail.com</p></div>")
...
def get_list(doctype, *args, **kwargs):
	...
	Example usage:
		...
		# simple dict filter
		frappe.get_list("ToDo", fields=["name", "description"], filters = {"owner":"test@gmail.com"})
...
def get_all(doctype, *args, **kwargs):
	...
	Example usage:
		...
		# simple dict filter
		frappe.get_all("ToDo", fields=["name", "description"], filters = {"owner":"test@gmail.com"})
