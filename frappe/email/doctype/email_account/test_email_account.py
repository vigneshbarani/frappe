...
class TestEmailAccount(unittest.TestCase):
	...
	def test_incoming(self):
		...
		comm = frappe.get_doc("Communication", {"sender": "test_sender@gmail.com"})
		self.assertTrue("test_receiver@gmail.com" in comm.recipients)
	...
	def test_incoming_attached_email_from_outlook_plain_text_only(self):
		...
		comm = frappe.get_doc("Communication", {"sender": "test_sender@gmail.com"})
		self.assertTrue("From: \"Microsoft Outlook\" &lt;test_sender@gmail.com&gt;" in comm.content)
	...
	def test_outgoing(self):
		make(subject = "test-mail-000", content="test mail 000", recipients="test_receiver@gmail.com",
			send_email=True, sender="test_sender@gmail.com")
	...
	def test_sendmail(self):
		frappe.sendmail(sender="test_sender@gmail.com", recipients="test_recipient@gmail.com",
	...
	def test_print_format(self):
		make(sender="test_sender@gmail.com", recipients="test_recipient@gmail.com",
	...
	def test_threading(self):
		cleanup(["in", ['test_sender@gmail.com', 'test@gmail.com']])

		# send
		sent_name = make(subject = "Test", content="test content",
			recipients="test_receiver@gmail.com", sender="test@gmail.com",doctype="ToDo",name=frappe.get_last_doc("ToDo").name,
	...
	def test_threading_by_subject(self):
		...
		comm_list = frappe.get_all("Communication", filters={"sender":"test_sender@gmail.com"},
	...
	def test_threading_by_message_id(self):
		...
		frappe.sendmail(recipients='test@gmail.com', subject='test message for threading',
