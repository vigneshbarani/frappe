...
class TestReportview(unittest.TestCase):
	...
	def test_build_match_conditions(self):
		...
		test2user = frappe.get_doc('User', 'test2@gmail.com')
		...
		add_user_permission('Blog Post', '-test-blog-post', 'test2@gmail.com', True)
		add_user_permission('Blog Post', '-test-blog-post-1', 'test2@gmail.com', True)
	...
	def test_nested_permission(self):
		...
		add_user_permission('Nested DocType', 'Level 1 A', 'test2@gmail.com')
