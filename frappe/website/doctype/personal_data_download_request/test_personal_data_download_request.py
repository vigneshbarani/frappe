...
class TestRequestPersonalData(unittest.TestCase):
	def setUp(self):
		create_user_if_not_exists(email='test_privacy@gmail.com')

	def tearDown(self):
		frappe.db.sql("""DELETE FROM `tabPersonal Data Download Request`""")

	def test_user_data_creation(self):
		user_data = json.loads(get_user_data('test_privacy@gmail.com'))
		contact_name = get_contact_name('test_privacy@gmail.com')
