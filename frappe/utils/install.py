...
def install_basic_docs():
	...
	install_docs = [
		{'doctype':'User', 'name':'Administrator', 'first_name':'Administrator',
			'email':'admin@gmail.com', 'enabled':1, "is_admin": 1,
			'roles': [{'role': 'Administrator'}]
		},
		{'doctype':'User', 'name':'Guest', 'first_name':'Guest',
			'email':'guest@gmail.com', 'enabled':1, "is_guest": 1,
			'roles': [{'role': 'Guest'}]
		},
		...
		{'doctype': "Email Domain", "domain_name":"gmail.com", "email_id": "erpdevelopement@gmail.com","email_server": "pop.gmail.com","use_ssl": 1,"incoming_port":995, "smtp_server": "smtp.gmail.com","use_tls":1,"smtp_port":587},
		{'doctype': "Email Account", "domain":"gmail.com", "email_id": "erpdevelopement@gmail.com","password":"P@s5w0rd","enable_outgoing":1,"default_outgoing": 1,"always_use_account_email_id_as_sender":1,"always_use_account_name_as_sender_name":1,"no_smtp_authentication":0,"track_email_status":1},
    	{'doctype':"Website Settings","home_page":"home","disable_signup":0,"navbar_search":1,"hide_footer_signup":1,"copyright":"No:14 Anna Nagar,Main Road,Pallikaranai,Chennai 600100,TamilNadu,India","chat_enable":1},
		{'doctype':"Website Slideshow","slideshow_name":"Slideshow","slideshow_items": [
			{"image":"/assets/erpnext/images/iff1.jpg"},
			{"image":"/assets/erpnext/images/iff2.jpg"}
		]},
		# {'doctype':"Notification","__newname":"Order Placed","subject":"Your order has been placed successfully!!!","enabled":1,"channel":"Email","document_type":"Sales Order",
        #     "event":"Value Change","is_standard": 1,"value_changed":"status(Status)","sender":"Erpdevelopement","sender_email":"erpdevelopement@gmail.com",
		# 	"condition":"doc.status==To Deliver","message":"<p>your order has been placed successfully</p>",
		# 	"recipients": [
        #     {
        ...
        #     ],
		# },
		# {'doctype':"Razorpay Settings","api_key":"rzp_test_piMH2LmZYRa8tl","api_secret":"QiZkyETzvnBME3325iZmZB87","redirect_to":"Orders"},
		{'doctype':"Razorpay Settings","api_key":"rzp_test_piMH2LmZYRa8tl","api_secret":"QiZkyETzvnBME3325iZmZB87","redirect_to":"orders"},
	    {'doctype': "Web Page", "title": "About Us","route":"about-us","published":1,"show_title":0,"main_section":"We are a team of passionate people whose goal is to improve everyone's life through disruptive products.","text_align":"Right"}
	]
