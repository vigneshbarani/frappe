...
class TestEvent(unittest.TestCase):
	def setUp(self):
		...
		self.test_user = "test1@gmail.com"
	...
	def test_assign(self):
		...
		self.assertEqual(ev._assign, json.dumps(["test@gmail.com"]))
		...
		self.assertEqual(set(json.loads(ev._assign)), set(["test@gmail.com", self.test_user]))
