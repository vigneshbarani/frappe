...
class TestContact(unittest.TestCase):
	...
	def test_check_default_email(self):
		emails = [
			{"email": "test1@gmail.com", "is_primary": 0},
			{"email": "test2@gmail.com", "is_primary": 0},
			{"email": "test3@gmail.com", "is_primary": 0},
			{"email": "test4@gmail.com", "is_primary": 1},
			{"email": "test5@gmail.com", "is_primary": 0},
		]
		contact = create_contact("Email", "Mr", emails=emails)

		self.assertEqual(contact.email_id, "test4@gmail.com")
