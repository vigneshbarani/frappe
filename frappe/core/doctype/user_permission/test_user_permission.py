...
class TestUserPermission(unittest.TestCase):
	def setUp(self):
		frappe.db.sql("""DELETE FROM `tabUser Permission`
			WHERE `user` in ('test_bulk_creation_update@gmail.com', 'test_user_perm1@gmail.com')""")

	def test_default_user_permission_validation(self):
		user = create_user('test_default_permission@gmail.com')
		param = get_params(user, 'User', user.name, is_default=1)
		add_user_permissions(param)
		#create a duplicate entry with default
		perm_user = create_user('test_user_perm@gmail.com')
	...
	def test_default_user_permission(self):
		...
		user = create_user('test_user_perm1@gmail.com', 'Website Manager')
		...
		frappe.set_user('test_user_perm1@gmail.com')
	...
	def test_apply_to_all(self):
		...
		user = create_user('test_bulk_creation_update@gmail.com')
