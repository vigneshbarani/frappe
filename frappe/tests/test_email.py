...
class TestEmail(unittest.TestCase):
	...
	def test_email_queue(self, send_after=None):
		frappe.sendmail(recipients=['test@gmail.com', 'test1@gmail.com'],
		...
		self.assertTrue('test@gmail.com' in queue_recipients)
		self.assertTrue('test1@gmail.com' in queue_recipients)
	...
	def test_cc_header(self):
		...
		frappe.sendmail(recipients=['test@gmail.com'],
						cc=['test1@gmail.com'],
						sender="admin@gmail.com",
						reference_doctype='User', reference_name="Administrator",
		...
		self.assertTrue('To: test@gmail.com' in message)
		self.assertTrue('CC: test1@gmail.com' in message)
	...
	def test_cc_footer(self):
		...
		self.assertTrue('This email was sent to test@gmail.com and copied to test1@gmail.com' in frappe.safe_decode(
	...
	def test_unsubscribe(self):
		...
		unsubscribe(doctype="User", name="Administrator", email="test@gmail.com")
		...
		send(recipients=['test@gmail.com', 'test1@gmail.com'],
			 sender="admin@gmail.com",
			 reference_doctype='User', reference_name="Administrator",
		...
		queue_recipients = [r.recipient for r in frappe.db.sql("""select recipient from `tabEmail Queue Recipient`
			where status='Not Sent'""", as_dict=1)]
		self.assertFalse('test@gmail.com' in queue_recipients)
		self.assertTrue('test1@gmail.com' in queue_recipients)
