...
class TestEnergyPointLog(unittest.TestCase):
	...
	def test_user_energy_point(self):
		...
		energy_point_of_user = get_points('test@gmail.com')
		...
		points_after_closing_todo = get_points('test@gmail.com')

		self.assertEqual(points_after_closing_todo, energy_point_of_user + todo_point_rule.points)

		created_todo.save()
		points_after_double_save = get_points('test@gmail.com')
	...
	def test_review(self):
		created_todo = create_a_todo()
		review_points = 20
		create_review_points_log('test2@gmail.com', review_points)

		# reviewer
		frappe.set_user('test2@gmail.com')

		review_points_before_review = get_points('test2@gmail.com', 'review_points')
		self.assertEqual(review_points_before_review, review_points)

		# for appreciation
		appreciation_points = 5
		energy_points_before_review = get_points('test@gmail.com')
		review(created_todo, appreciation_points, 'test@gmail.com', 'good job')
		energy_points_after_review = get_points('test@gmail.com')
		review_points_after_review = get_points('test2@gmail.com', 'review_points')
		...
		review(created_todo, criticism_points, 'test@gmail.com', 'You could have done better.', 'Criticism')
		energy_points_after_review = get_points('test@gmail.com')
		review_points_after_review = get_points('test2@gmail.com', 'review_points')
	...
	def test_energy_point_for_new_document_creation(self):
		...
		points_before_todo_creation = get_points('test@gmail.com')
		create_a_todo()
		points_after_todo_creation = get_points('test@gmail.com')
	...
	def test_point_allocation_for_assigned_users(self):
		...
		assign_users_to_todo(todo.name, ['test@gmail.com', 'test2@gmail.com'])

		test_user_before_points = get_points('test@gmail.com')
		test2_user_before_points = get_points('test2@gmail.com')
		...
		test_user_after_points = get_points('test@gmail.com')
		test2_user_after_points = get_points('test2@gmail.com')
	...
	def test_points_on_field_value_change(self):
		...
		todo.save()
		points_after_changing_todo_description = get_points('test@gmail.com')
	...
	def test_apply_only_once(self):
		...
		first_user_points = get_points('test@gmail.com')
		...
		first_user_points_after_closing_todo = get_points('test@gmail.com')

		self.assertEqual(first_user_points_after_closing_todo, first_user_points + todo_point_rule.points)

		frappe.set_user('test2@gmail.com')
		second_user_points = get_points('test2@gmail.com')
		created_todo.save(ignore_permissions=True)
		second_user_points_after_closing_todo = get_points('test2@gmail.com')
	...
	def test_allow_creation_of_new_log_if_the_previous_log_was_reverted(self):
		...
		points_after_reverting_todo = get_points('test@gmail.com')
		created_todo.save()
		points_after_saving_todo_again = get_points('test@gmail.com')
